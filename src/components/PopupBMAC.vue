      ...
      <div class="relative bg-white rounded-2xl shadow-2xl max-w-lg w-full overflow-hidden transform transition-all">
        ...
        <div class="p-6 flex flex-col items-center">
          <div class="text-center mb-6">
            <h2 class="text-2xl font-bold text-gray-800 mb-2">Is this tool useful for your business? ☕</h2>
            <p class="text-gray-600">
              If you enjoy using SwiftInvoice, consider supporting its development. 
              Your support helps keep this tool free and regularly updated for everyone!
            </p>
          </div>

          <!-- Buy Me a Coffee Section -->
          <a href="https://buymeacoffee.com/sozin" target="_blank" rel="noopener noreferrer" 
             class="w-full bg-[#FFDD00] rounded-xl flex flex-col items-center justify-center text-gray-800 p-6 relative overflow-hidden shadow-sm hover:shadow-md transition-all group hover:-translate-y-1 block cursor-pointer">
